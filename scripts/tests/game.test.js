...
describe("game object contains correct key", () => {
    ...
    test("lastNumber key exists", () => {
        expect("lastButton" in game).toBe(true); 
    });
    test("turnInProgress key exists and is false", () => {
...
describe("newGame works correctly", () => {
    ...
    test("should clear the players score", () => {
...
describe("gameplay works correctly", () => {
    ...
    test("should add correct class to the button to light it up", () => {
